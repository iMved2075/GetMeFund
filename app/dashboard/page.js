      ...
      <div className='flex flex-col gap-5 m-10 bg-slate-900 rounded-xl p-10'>
        ...
        <div className='flex justify-between border-2 border-slate-800 rounded-xl'>
          ...
          <div className="social md:flex hidden gap-3 my-10 p-2 pr-7">
            ...
            <a href={socialLinks.facebook || '#'} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center justify-center w-10 h-10 rounded-full bg-slate-800/60 ring-1 ring-slate-700 hover:bg-slate-700 transition mt-2">
              <img
                ...
                className="w-6 h-6 invert-50 group-hover:invert-0"
                alt="Facebook"
              />
            </a>
            <a href={socialLinks.twitter || '#'} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center justify-center w-10 h-10 rounded-full bg-slate-800/60 ring-1 ring-slate-700 hover:bg-slate-700 transition mt-2">
              <img
            ...
            <a href={socialLinks.linkedin || '#'} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center justify-center w-10 h-10 rounded-full bg-slate-800/60 ring-1 ring-slate-700 hover:bg-slate-700 transition mt-2">
              <img
            ...
            <a href={socialLinks.instagram || '#'} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center justify-center w-10 h-10 rounded-full bg-slate-800/60 ring-1 ring-slate-700 hover:bg-slate-700 transition mt-2">
              <img
            ...
            <a href={socialLinks.github || '#'} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center justify-center w-10 h-10 rounded-full bg-slate-800/60 ring-1 ring-slate-700 hover:bg-slate-700 transition mt-2">
              <img
            ...
            <a href={socialLinks.youtube || '#'} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center justify-center w-10 h-10 rounded-full bg-slate-800/60 ring-1 ring-slate-700 hover:bg-slate-700 transition mt-2">
              <img
        ...
        <div className="social md:hidden flex gap-3 p-2 border-2 border-slate-800 rounded-xl">
            {/* Social icons now link to editable state */}
            <a href={socialLinks.facebook || '#'} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center justify-center w-8 h-8 rounded-full bg-slate-800/60 ring-1 ring-slate-700 hover:bg-slate-700 transition mt-2">
              <img
                src="data:image/svg+xml;base64,"
                className="w-4 h-4 invert-50 group-hover:invert-0"
                alt="Facebook"
              />
            </a>
            <a href={socialLinks.twitter || '#'} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center justify-center w-8 h-8 rounded-full bg-slate-800/60 ring-1 ring-slate-700 hover:bg-slate-700 transition mt-2">
              <img
                src="data:image/svg+xml;base64,"
                className="w-4 h-4 invert-50 group-hover:invert-0"
                alt="X"
            ...
            <a href={socialLinks.linkedin || '#'} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center justify-center w-8 h-8 rounded-full bg-slate-800/60 ring-1 ring-slate-700 hover:bg-slate-700 transition mt-2">
              <img
                src="data:image/svg+xml;base64,"
                className="w-4 h-4 invert-50 group-hover:invert-0"
                alt="LinkedIn"
            ...
            <a href={socialLinks.instagram || '#'} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center justify-center w-8 h-8 rounded-full bg-slate-800/60 ring-1 ring-slate-700 hover:bg-slate-700 transition mt-2">
              <img
                src="data:image/svg+xml;base64,"
                className="w-4 h-4 invert-50 group-hover:invert-0"
                alt="Instagram"
            ...
            <a href={socialLinks.github || '#'} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center justify-center w-8 h-8 rounded-full bg-slate-800/60 ring-1 ring-slate-700 hover:bg-slate-700 transition mt-2">
              <img
                src="data:image/svg+xml;base64," alt="GitHub"
                className="w-4 h-4 invert-50 group-hover:invert-0"
              />
            </a>
            <a href={socialLinks.youtube || '#'} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center justify-center w-8 h-8 rounded-full bg-slate-800/60 ring-1 ring-slate-700 hover:bg-slate-700 transition mt-2">
              <img
                src="data:image/svg+xml;base64,"
                className="w-4 h-4 invert-50 group-hover:invert-0"
                alt="YouTube"
