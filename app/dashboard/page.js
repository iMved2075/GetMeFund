    ...
    <>
      <div className='flex flex-col gap-5 m-10 bg-slate-900 rounded-xl p-10'>
        ...
        <div className="social md:hidden flex gap-3 p-2 border-2 border-slate-800 rounded-xl">
          ...
          {socialLinks.twitter && (
            <a href={socialMedia.twitter} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center justify-center w-8 h-8 md:w-10 md:h-10 rounded-full bg-slate-800/60 ring-1 ring-slate-700 hover:bg-slate-700 transition">
              <img src="data:image/svg+xml;base64," className="w-4 h-4 md:w-6 md:h-6 invert-50 group-hover:invert-0" alt="X" />
            </a>
          )}
          {socialLinks.linkedin && (
            <a href={socialMedia.linkedin} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center justify-center w-8 h-8 md:w-10 md:h-10 rounded-full bg-slate-800/60 ring-1 ring-slate-700 hover:bg-slate-700 transition">
              <img src="data:image/svg+xml;base64," className="w-4 h-4 md:w-6 md:h-6 invert-50 group-hover:invert-0" alt="LinkedIn" />
            </a>
          )}
          {socialLinks.instagram && (
            <a href={socialMedia.instagram} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center justify-center w-8 h-8 md:w-10 md:h-10 rounded-full bg-slate-800/60 ring-1 ring-slate-700 hover:bg-slate-700 transition">
              <img src="data:image/svg+xml;base64," className="w-4 h-4 md:w-6 md:h-6 invert-50 group-hover:invert-0" alt="Instagram" />
            </a>
          )}
          {socialLinks.github && (
            <a href={socialMedia.github} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center justify-center w-8 h-8 md:w-10 md:h-10 rounded-full bg-slate-800/60 ring-1 ring-slate-700 hover:bg-slate-700 transition">
              <img src="data:image/svg+xml;base64," alt="GitHub" className="w-4 h-4 md:w-6 md:h-6 invert-50 group-hover:invert-0" />
            </a>
          )}
          {socialLinks.youtube && (
            <a href={socialMedia.youtube} target="_blank" rel="noopener noreferrer" className="group inline-flex items-center justify-center w-8 h-8 md:w-10 md:h-10 rounded-full bg-slate-800/60 ring-1 ring-slate-700 hover:bg-slate-700 transition">
              <img src="data:image/svg+xml;base64," className="w-4 h-4 md:w-6 md:h-6 invert-50 group-hover:invert-0" alt="YouTube" />
            </a>
          )}
          <button
