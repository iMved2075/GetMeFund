  ...
  return (
    <>
      <div className="flex justify-center text-white flex-col items-center p-10 gap-5">
        <div className="flex gap-2 items-center font-bold text-5xl bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent"> FUND ME <span><img src="./coin_bounce.gif" alt="coin_gif" width={60} /></span></div>
        <p>
      ...
      <div className="text-white container mx-auto pt-10 pb-20 px-15">
        <h2 className="text-3xl font-bold text-center mb-20 bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">Your fans can support you.</h2>
        <div className="flex md:flex-row md:gap-4 flex-col gap-7 justify-around">
          <div className="item space-y-3 flex flex-col justify-center items-center">
            <img className="bg-slate-400 rounded-full p-2 text-black" width={80} src="/man.gif" alt="man" />
            <p className="font-bold">Fund Yourself</p>
            <p className="text-center"> Get the resources you need to bring your project to life.</p>
          </div>
          <div className="item space-y-3 flex flex-col justify-center items-center">
            ...
            <p className="text-center"> Connect with backers who want to support your vision.</p>
          </div>
          <div className="item space-y-3 flex flex-col justify-center items-center">
            ...
            <p className="text-center"> Leverage your community to gain traction and funding.</p>
          </div>
        </div>
      </div>
      <div className="bg-cyan-700 h-1 opacity-20">
      ...
      <div className="flex flex-col justify-center items-center text-white container mx-auto pt-10 pb-20">
        <h2 className="text-3xl font-bold text-center mb-20 bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">Learn more about us.</h2>
        <iframe src="https://www.youtube.com/embed/KOaeDHeJ80I?si=fGHdg9d9YwO165xX" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen className="md:w-[560px] md:h-[315px] "></iframe>
      </div>
    </>
  );
}
