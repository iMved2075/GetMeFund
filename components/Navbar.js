...
const Navbar = () => {
  ...
  // Don't render session-dependent content until client-side hydration is complete
    ...
    return (
      <nav className='bg-gray-900 text-white flex justify-between'>
        <Link href={"/"} className="logo font-bold p-3 text-2xl flex flex-row gap-2">
          ...
          <span className="bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">GetMeFund!</span>
        </Link>
      ...
      <div className='pt-2 relative'>
        {session && <>
          <button
            ...
            className="hover:cursor-pointer md:w-44 w-10 h-10 text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-2 focus:outline-none focus:ring-cyan-300 dark:focus:ring-cyan-800 font-medium rounded-full md:rounded-lg text-sm md:px-4 md:p-2 p-0 text-center me-2 mb-2 inline-flex justify-center md:justify-between items-center"
            type="button"
          >
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="md:inline hidden" fill="none">
              <path fill="skyblue" d="M3 18v-2h18v2zm0-5v-2h18v2zm0-5V6h18v2z" />
            </svg>
          </button>
